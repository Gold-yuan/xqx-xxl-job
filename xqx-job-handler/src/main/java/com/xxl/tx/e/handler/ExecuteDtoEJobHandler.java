...
@JobHandler(value = "ExecuteDtoEJobHandler")
@Component
public class ExecuteDtoEJobHandler extends IJobHandler{
	@Override
	public ReturnT<String> execute(String param) throws Exception {
		Iterator<ReceivePO> iterator = ReceiveDtoEHandler.dataCache.iterator();
