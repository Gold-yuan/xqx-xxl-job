...
@JobHandler(value = "ExecuteAtoBJobHandler")
@Component
public class ExecuteAtoBJobHandler extends IJobHandler {

	@Override
	public ReturnT<String> execute(String param) throws Exception {
		Iterator<ReceivePO> iterator = ReceiveAtoBHandler.dataCache.iterator();
