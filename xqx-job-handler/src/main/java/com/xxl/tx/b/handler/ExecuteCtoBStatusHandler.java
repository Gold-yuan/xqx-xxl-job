...
@JobHandler(value = "ExecuteCtoBStatusHandler")
@Component
public class ExecuteCtoBStatusHandler extends IJobHandler{
	@Override
	public ReturnT<String> execute(String param) throws Exception {
		Iterator<ReceivePO> iterator = ReceiveCtoBStatusHandler.dataCache.iterator();
		while (iterator.hasNext()) {
			...
			if (receivePO.isFinish()) {
				...
				// TODO 项目B的地址
				String url = "http://localhost:8092/accounts/finish" + receivePO.getData();
