...
@JobHandler(value = "ExecuteCtoDJobHandler")
@Component
public class ExecuteCtoDJobHandler extends IJobHandler{
	@Override
	public ReturnT<String> execute(String param) throws Exception {
		Iterator<ReceivePO> iterator = ReceiveCtoDHandler.dataCache.iterator();
		while (iterator.hasNext()) {
			...
			if (receivePO.isFinish()) {
				...
				// TODO 项目B的地址
				String url = "http://localhost:8094/accounts/transfer" + receivePO.getData();
